...
type SkillSourceInfoTarget = Pick<CompanySkill, "companyId" | "sourceType" | "sourceLocator" | "metadata">;
...
function resolveDesiredSkillKeys(skills: SkillReferenceTarget[], config: Record<string, unknown>) {
