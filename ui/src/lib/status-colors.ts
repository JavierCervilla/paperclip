...
export const issueStatusIcon: Record<string, string> = {
  ...
  waiting_for_human: "text-sky-600 border-sky-600 dark:text-sky-400 dark:border-sky-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  waiting_for_human: "text-sky-600 dark:text-sky-400",
...
export const statusBadge: Record<string, string> = {
  ...
  waiting_for_human: "bg-sky-100 text-sky-700 dark:bg-sky-900/50 dark:text-sky-300",
